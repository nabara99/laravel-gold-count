            ...
            $('#showIncomeBtn').click(function() {
                ...
                <table class="table table-bordered table-sm">
                    ...
                    data.forEach(item => {
                        ...
                        const terima = penghasilan - kasbon;

                        html += `<tr>
                    <td>${item.name}</td>
                    <td>${item.jumlah_hadir}</td>
                    <td>Rp ${penghasilan.toLocaleString('id-ID', {minimumFractionDigits: 2})}</td>
                    <td>Rp ${kasbon.toLocaleString('id-ID', {minimumFractionDigits: 2})}</td>
                    <td>Rp ${terima.toLocaleString('id-ID', {minimumFractionDigits: 2})}</td>
                </tr>`;
                    });
